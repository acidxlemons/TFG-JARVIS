...
Este módulo es una versión standalone del conector BOE para uso con el servidor MCP.
"""
...
class BoeConnector:
    ...
    def get_law_text(self, law_id: str) -> Dict:
        ...
        headers = {"User-Agent": "MCP-BOE-Server/1.0", "Accept": "application/xml"}
