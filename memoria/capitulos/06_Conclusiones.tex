...
Para contextualizar las contribuciones de este proyecto, se presenta una comparación con soluciones RAG comerciales y de código abierto relevantes:

\begin{table}[H]
\centering
\caption{Comparación del sistema con soluciones RAG alternativas.}
\label{tab:comparacion}
\begin{tabular}{lccccc}
\toprule
\textbf{Característica} & \textbf{Nuestro} & \textbf{ChatGPT} & \textbf{Copilot} & \textbf{LangChain} & \textbf{PrivateGPT} \\
\midrule
On-Premise 100\%    & \checkmark & $\times$ & $\times$ & \checkmark & \checkmark \\
Código abierto      & \checkmark & $\times$ & $\times$ & \checkmark & \checkmark \\
Multi-fuente RAG    & \checkmark & Parcial  & Parcial  & \checkmark & Parcial \\
OCR integrado       & \checkmark & $\times$ & $\times$ & $\times$   & $\times$ \\
Web Scraping        & \checkmark & $\times$ & Parcial  & \checkmark & $\times$ \\
Monitorización GPU  & \checkmark & $\times$ & $\times$ & $\times$   & $\times$ \\
SSO corporativo     & \checkmark & $\times$ & \checkmark & $\times$ & $\times$ \\
Servidor MCP (BOE)  & \checkmark & $\times$ & $\times$ & $\times$   & $\times$ \\
UI conversacional   & \checkmark & \checkmark & \checkmark & $\times$ & \checkmark \\
Coste por token     & 0 \euro{}  & \$\$\$  & \$\$\$  & Variable   & 0 \euro{} \\
\bottomrule
\end{tabular}
\end{table}
